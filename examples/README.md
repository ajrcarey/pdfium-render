...
* `attachments.rs`: iterates over the attachments in `test/attachments.pdf`, displaying information about each attachment. Run this example via `cargo run --example attachments`. 
