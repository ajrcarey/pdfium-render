...
impl<'a> PdfiumLibraryBindingsAccessor<'a> for PdfPageSquigglyAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Send for PdfPageSquigglyAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Sync for PdfPageSquigglyAnnotation<'a> {}
