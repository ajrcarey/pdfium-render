...
impl<'a> PdfiumLibraryBindingsAccessor<'a> for PdfPageStrikeoutAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Send for PdfPageStrikeoutAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Sync for PdfPageStrikeoutAnnotation<'a> {}
