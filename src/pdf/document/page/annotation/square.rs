...
impl<'a> PdfiumLibraryBindingsAccessor<'a> for PdfPageSquareAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Send for PdfPageSquareAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Sync for PdfPageSquareAnnotation<'a> {}
