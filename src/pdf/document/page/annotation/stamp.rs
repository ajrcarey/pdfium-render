...
impl<'a> PdfiumLibraryBindingsAccessor<'a> for PdfPageStampAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Send for PdfPageStampAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Sync for PdfPageStampAnnotation<'a> {}
