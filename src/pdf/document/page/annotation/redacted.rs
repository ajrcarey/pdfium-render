...
impl<'a> PdfiumLibraryBindingsAccessor<'a> for PdfPageRedactedAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Send for PdfPageRedactedAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Sync for PdfPageRedactedAnnotation<'a> {}
