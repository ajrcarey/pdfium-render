...
impl<'a> PdfiumLibraryBindingsAccessor<'a> for PdfPagePopupAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Send for PdfPagePopupAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Sync for PdfPagePopupAnnotation<'a> {}
