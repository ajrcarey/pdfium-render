...
impl<'a> PdfiumLibraryBindingsAccessor<'a> for PdfPageTextAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Send for PdfPageTextAnnotation<'a> {}

#[cfg(feature = "thread_safe")]
unsafe impl<'a> Sync for PdfPageTextAnnotation<'a> {}
