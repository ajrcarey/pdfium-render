...
Release 0.8.27 fixes a bug in certain string handling operations in the WASM bindings implementation.
...
* 0.8.27: fixes a WASM-specific bug in string termination detection when copying `FPDF_WIDESTRING` buffers to Pdfium's WASM address space.
